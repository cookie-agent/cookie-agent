...
| [Refactor phase 1: test layout and build hygiene](refactor-phase-1-test-layout.md) | Draft, implementation authorized; split test monoliths, collapse engine test hooks, dev-profile debuginfo |
| [Refactor phase 2: dependencies, bindings, CI, syntect](refactor-phase-2-dependencies-ci.md) | Draft, implementation authorized; single reqwest via oven-sdk, drop TypeScript bindings, CI diet, crates.io syntect |
| [Refactor phase 3: module splits](refactor-phase-3-module-splits.md) | Draft, implementation authorized; split `Inner`, `App`, transcript renderer, `SessionStore`, TUI reducer |
