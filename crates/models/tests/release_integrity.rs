...
fn oven_dependencies_use_one_pinned_git_revision_with_exact_publish_versions() {
    ...
    for pin in [
        "oven-sdk = { version = \"=0.5.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-anthropic = { version = \"=0.6.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-openai = { version = \"=0.5.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-google = { version = \"=0.5.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-google-vertex = { version = \"=0.5.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-bedrock = { version = \"=0.4.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-azure = { version = \"=0.4.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
        "oven-sdk-cohere = { version = \"=0.3.0\", git = \"https://github.com/cookie-agent/oven-sdk.git\", rev = \"f2d37f9f20fa6118049d1d88a174ecdfd55dc6b4\" }",
    ] {
